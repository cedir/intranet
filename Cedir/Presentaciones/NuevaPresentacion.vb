...
#End Region
    ...
    Private Sub cargarGrilla()
        ...
        For i = 0 To arrLineasEstudios.Count - 1
            ...
            totalMedicacion += cLineaEstudio.objeto.getTotalMedicacion
            Me.totalArancelAnestesia += cLineaEstudio.objeto.ArancelAnestesia
    ...
    Private Sub btnQuitarItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnQuitarItem.Click
        ...
        If TabControl1.SelectedIndex = 0 Then
            ...
            Else
                ...
                Dim totalParcialMedicacion As Single = cLinea.objeto.getTotalMedicacion()
    ...
    Private Function agregarLineaDeEstudio(ByVal nro As Int64) As Boolean
        ...
        If resp Then
            ...
            cLinea.objeto.cargarMedicacion()
            Dim totalParcialMedicacion As Single = cLinea.objeto.getTotalMedicacion()
            NewRow("Medicacion") = totalParcialMedicacion
            NewRow("Anestesia") = cLinea.objeto.ArancelAnestesia
    ...
    Private Sub cargarMedicacion(ByVal nro As Integer)
        ...
        While (i < cPresentacion.getLineasDeFacturacionEstudios.Count)
            cLinea = cPresentacion.getLineasDeFacturacionEstudios(i)
            If cLinea.objeto.nroEstudio = nro Then
                cLinea.objeto.cargarMedicacion()
                Dim nuevoTotal As Single = cLinea.objeto.getTotalMedicacion
        ...
        If respValidador Then
            ...
            If r = 6 Then
                ...
                While (i < cPresentacion.getLineasDeFacturacionEstudios.Count)
                    ...
                    cLinea.objeto.nroOrden = DataGrid1.Item(i, 2)
                    cLinea.objeto.importeMedicacion = Convert.ToDecimal(Me.DataGrid1.Item(i, 10))
                    cLinea.objeto.ArancelAnestesia = Convert.ToDecimal(Me.DataGrid1.Item(i, 11))
                    i += 1
                End While
                'consultas
                i = 0
...
#End Region
    ...
    Private Sub btnAnest_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAnest.Click
        ...
        Try
            ...
            For i = 0 To total.Length() - 1
                If total(i) <> 0 Then
                    clinea = arr(i)
                    clinea.objeto.ArancelAnestesia = total(i)
                    clinea.objeto.guardarArancelAnestesia()
    ...
    Private Sub PacienteToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles PacienteToolStripMenuItem.Click
        Dim est As Estudio
        est = cPresentacion.getLineasDeFacturacionEstudios(Me.DataGrid1.CurrentRowIndex).objeto
