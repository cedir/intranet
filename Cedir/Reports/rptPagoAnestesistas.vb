...
Public Class rptPagoAnestesistas
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptPagoAnestesistas.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Cedir.rptPagoAnestesistas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPagoAnestesistas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPagoAnestesistas = New rptPagoAnestesistas()
        rpt.Site = Me.Site
        Return rpt
    End Function
