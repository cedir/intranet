...
Public Class rptHonorariosCedir
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Cedir.rptHonorariosCedir.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptHonorariosCedir
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptHonorariosCedir = New rptHonorariosCedir()
        rpt.Site = Me.Site
        Return rpt
    End Function
