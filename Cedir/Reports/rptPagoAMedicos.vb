...
Public Class rptPagoAMedicos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Cedir.rptPagoAMedicos.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_campoObservaciones() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptPagoAMedicos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPagoAMedicos = New rptPagoAMedicos()
        rpt.Site = Me.Site
        Return rpt
    End Function
