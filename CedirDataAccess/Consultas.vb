...
Public Class Consultas
    ...
    Public Function getArancelesByObraSocial(ByVal idObraSocial As Integer, ByVal idPractica As Integer) As NpgsqlDataReader
        Dim stringSelect As String = "select ae." & com & "idEstudio" & com & ", ae." & com & "estudio" & com & ", " & com & "ae" & com & "." & com & "codigoMedico" & com & ", " & com & "ap" & com & "." & com & "Precio" & com & ", ap." & com & "fecha" & com & ", ap." & com & "precioAnestesia" & com & " from " & com & "cedirData" & com & "." & com & "AlmacenPreciosEstOS" & com & " as " & com & "ap" & com
