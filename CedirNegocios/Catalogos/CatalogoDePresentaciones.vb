...
Public Class CatalogoDePresentaciones
    ...
    Public Function delete(ByVal id As Integer) As String
        ...
        resp = daNuevo.update(com & "public" & com & "." & com & "tblDetalleEstudio" & com, com & "idFacturacion" & com & " = 0 ", " where " & com & "idFacturacion" & com & " = " & id)
    ...
    Private Function loadPresentaciones(ByVal condicion As String, ByVal order As String) As ArrayList
        ...
        While drPresentacion.Read()
            ...
            If (drPresentacion.Item("id") IsNot DBNull.Value) Then
                ...
                vPresentacion.comprobante.DocumentoCliente.NroDocumento = Convert.ToString(drPresentacion.Item("nroCuit"))
